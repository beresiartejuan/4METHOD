...
class MIS(object):
  def __init__(self, opcion, imagen, mensaje=False):
    if op[0] == "l":
	    mensaje = leer(imagen)
	    print("El mensaje oculto es:")
	    print(mensaje)
    elif op[0] == "e":
	    ocultar_texto(mensaje, imagen)
    else:
	    print("Error en la clase MIS.")
      print("las opciones son: leer y escribir")
      
#Clase para importar y utilizar
